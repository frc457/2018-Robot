...
import org.greasemonkeys457.robot2018.commands.DriveRunGearboxes;
...
public class OI {
    ...
    public OI () {
        ...
        // Gearbox break-in
        driverA.whenPressed(new DriveRunGearboxes(0.5));
        driverB.whenPressed(new DriveRunGearboxes(-0.5));
        driverX.whenPressed(new DriveRunGearboxes(0.0));
